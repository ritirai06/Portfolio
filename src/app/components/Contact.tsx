      ...
      <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                {[
                  { icon: Mail, label: "ritirai0612@gmail.com", href: "mailto:ritirai0612@gmail.com", color: "from-red-400 to-pink-400" },
                  { icon: Phone, label: "+91 9005529331", href: "tel:+919005529331", color: "from-green-400 to-blue-400" },
                  { icon: Github, label: "GitHub Profile", href: "https://github.com/ritirai06", color: "from-gray-400 to-gray-600" },
                  { icon: Linkedin, label: "LinkedIn Profile", href: "https://www.linkedin.com/in/ritirai06", color: "from-blue-400 to-blue-600" }
                ].map((social, index) => (
                  <motion.a
                    key={social.label}
                    href={social.href}
        ...
        >
          <p className="text-gray-500">
            © 2026 Riti Rai. Building intelligent solutions with AI & Machine Learning.
          </p>
        </motion.div>
      </div>
    </section>
